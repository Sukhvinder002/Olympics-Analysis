# -*- coding: utf-8 -*-
"""
Created on Sat Jan 13 23:44:50 2024
...
if user_menu == 'Overall Analysis':
    editions = df['Year'].unique().shape[0] -1    # editions is years 
    ...
    # Participating Nations over the Year
...
if user_menu == 'Athlete wise Analysis':
    ...
    famous_sports = ['Basketball','Judo','Football', 'Tug-Of-War', 'Athletics','Swimming','Badminton',
                     'Sailing', 'Art Competitions','Handball','Weightlifting', 'Wrestling','Water Polo', 
                     'Hockey', 'Rowing', 'Fencing', 'Shooting', 'Boxing', 'Taekwondo', 'Cycling',  'Diving',
